...
![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-8-2.png)<!-- -->
...
![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-18-3.png)<!-- -->
...
![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-18-4.png)<!-- -->
...
![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
...
![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-19-2.png)<!-- -->
...
![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-19-3.png)<!-- -->
...
![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-19-4.png)<!-- -->
...
```
    ...
    ## 0.09716385 0.03100000 0.97000000 0.05000000 0.06533948 0.13284018
...
```
    ...
    ##    mantelr      pval1      pval2      pval3  llim.2.5% ulim.97.5% 
    ##  0.1321427  0.0010000  1.0000000  0.0010000  0.1029205  0.1671340
...
```
    ...
    ##    mantelr      pval1      pval2      pval3  llim.2.5% ulim.97.5% 
    ##  0.1990557  0.0010000  1.0000000  0.0010000  0.1714021  0.2243354
...
```
    ...
    ##    mantelr      pval1      pval2      pval3  llim.2.5% ulim.97.5% 
    ##  0.3992419  0.0010000  1.0000000  0.0010000  0.3779541  0.4215992
...
![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-22-1.png)<!-- -->
...
![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->

``` r
logplotRootRhizo
```

![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-24-2.png)<!-- -->

``` r
Glombarplot
```

![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-24-3.png)<!-- -->

``` r
ShannonRhizo
```

![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-24-4.png)<!-- -->

``` r
SimpsonRhizo
```

![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-24-5.png)<!-- -->

``` r
ShannonSoils
```

![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-24-6.png)<!-- -->

``` r
Simpsonroots
```

![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-24-7.png)<!-- -->

``` r
Shannonroots
```

![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-24-8.png)<!-- -->

``` r
Simpsonroots
```

![](RedwoodFungi_Analyses_files/figure-gfm/unnamed-chunk-24-9.png)<!-- -->
